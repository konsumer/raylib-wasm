This is the start of some ideas about making raylib games in JS for the web. It includes raylib 4.5.0 & raygui. You can see some examples [here](https://konsumer.js.org/raylib-wasm).
