...
async function raylib_run(canvas, userInit, userUpdate) {
  ...
  // : Vector3Project(Vector3, Vector3) => Vector3
  const _Vector3Project = mod.cwrap('Vector3Project', 'void', ['pointer', 'pointer', 'pointer'])
  raylib.Vector3Project = (v1, v2) => {
    const _ret = new raylib.Vector3()
    _Vector3Project(_ret._address, v1._address, v2._address)
    return _ret
  }

  // : Vector3Reject(Vector3, Vector3) => Vector3
  const _Vector3Reject = mod.cwrap('Vector3Reject', 'void', ['pointer', 'pointer', 'pointer'])
  raylib.Vector3Reject = (v1, v2) => {
    const _ret = new raylib.Vector3()
    _Vector3Reject(_ret._address, v1._address, v2._address)
    return _ret
  }
  ...
  raylib.MatrixPerspective = (fovY, aspect, nearPlane, farPlane) => {
    const _ret = new raylib.Matrix()
    _MatrixPerspective(_ret._address, fovY, aspect, nearPlane, farPlane)
    return _ret
  }
  ...
  raylib.MatrixOrtho = (left, right, bottom, top, nearPlane, farPlane) => {
    const _ret = new raylib.Matrix()
    _MatrixOrtho(_ret._address, left, right, bottom, top, nearPlane, farPlane)
    return _ret
  }
